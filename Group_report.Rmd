...
The result shows the best subset is (1,0,1,1,1) with MSE 60.15763. From the plot, we can observe that with the number of features increases, in general, the values of MSE decreases. For the best subset, its' MSE minimized when the number of features is 4. When the number of features is small, the model can be inaccurate, but if with too many parameters, the model will be difficult to use and interpret since it's overfitted.
...
```{r,echo=TRUE,out.height='30%', fig.align='center',results='hide',fig.show = 'hide'}
